...
const HomeBanner = () => {
  ...
  const backgroundStyles = {
    ...
    backgroundImage: isMobile
      ? "url('/banner_images/membership_page_banner.jpg')"
      : "url('/banner_images/membership_page_banner.jpg')",
  };
  ...
  return (
    <>
      <Container fluid className='px-lg-5 p-0'>
        <Container fluid style={{ backgroundImage: 'url(/membership.png)', height: '750px', backgroundSize: 'cover' }} className='d-lg-flex d-none'>
        </Container>
